...
class VideoProcessor(VideoProcessorBase):
    def __init__(self):
        ...
        # ✅ FIX 1: Initialize the threshold inside the thread-safe class
    ...
    def recv(self, frame):
        ...
        try:
            if results.pose_landmarks:
                ...
                # ✅ FIX 2: Use the instance variable (self.) to prevent thread crashing
...
# UI UPDATE 
# -------------------------------
# ✅ FIX 3: Safely pass the slider value into the running processor
if ctx.video_processor:
    ctx.video_processor.confidence_threshold = confidence_threshold

# ✅ FIX 4: Use a loop to continuously pull metrics while the camera is on
if ctx.state.playing:
    while True:
        ...
        # Give the CPU a tiny break between updates
        time.sleep(0.1)